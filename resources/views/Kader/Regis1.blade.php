    ...
    <div class="p-4">
        ...
        <div class="flex justify-start mb-4">
            <a href="/Regis-anak" class="">
                <div class="bg-slate-400 py-1 px-6 shadow-lg text-slate-600 rounded-l-lg">

                    <p class="font-semibold">Anak</p>
                </div>
            </a>
            <a href="/Regis-bumil">
                <div class="bg-sky-700 py-1 px-6 text-slate-300 rounded-r-lg">

                    <p class="font-semibold">Bumil</p>
                </div>
            </a>
        </div>
        <form method="POST" action="{{ route('simpanRegis1') }}" class="font text-sky-900">
            @csrf
