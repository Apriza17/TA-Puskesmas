                ...
                <li class="pt-1">
                    ...
                    <ul
                     ...
                     peer-checked/menu:max-h-48">
                        <li>
                            <a href="/Laporan" class="block px-4 py-1 rounded hover:bg-sky-800 hover:text-white">Rekap
                                Bulanan Anak</a>
                        </li>
                        <li>
                            <a href="/Laporan-Gizi"
                                class="block px-4 py-1 rounded hover:bg-sky-800 hover:text-white">Rekap Gizi Anak</a>
                        </li>
                        <li>
                            <a href="/Laporan-Sartika"
                                class="block px-4 py-1 rounded hover:bg-sky-800 hover:text-white">Rekap Sartika</a>
                        </li>
                    </ul>
                </li>
